...
import com.plannedly.activity.MainActivity
import com.plannedly.activity.SignInActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        val channelId = "plannedly_notification_channel_id"
